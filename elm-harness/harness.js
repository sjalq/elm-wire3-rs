...
var $author$project$Harness$GotRequest = function (a) {
...
var $lamdera$codecs$Lamdera$Wire3$encodeInt64 = function (i) {
	...
	var n0 = A2($elm$core$Basics$modBy, 256, n);
	var n1 = A2(
		$elm$core$Basics$modBy,
		256,
		$lamdera$codecs$Lamdera$Wire3$intDivBy$(256, n));
	var n2 = A2(
		$elm$core$Basics$modBy,
		256,
		$lamdera$codecs$Lamdera$Wire3$intDivBy$(
			256,
			$lamdera$codecs$Lamdera$Wire3$intDivBy$(256, n)));
	var n3 = A2(
		$elm$core$Basics$modBy,
	...
	var ei = function (e) {
		return $elm$bytes$Bytes$Encode$sequence(
			$elm$core$List$map$($elm$bytes$Bytes$Encode$unsignedInt8, e));
	};
	return (n <= 215) ? ei(
		_List_fromArray(
			[n])) : ((n <= 9431) ? ei(
		_List_fromArray(
			[
				216 + $lamdera$codecs$Lamdera$Wire3$intDivBy$(256, n - 216),
				A2($elm$core$Basics$modBy, 256, n - 216)
			])) : ((_Utils_cmp(n, 256 * 256) < 0) ? ei(
		_List_fromArray(
			[252, n1, n0])) : ((_Utils_cmp(n, (256 * 256) * 256) < 0) ? ei(
		_List_fromArray(
			[253, n2, n1, n0])) : ((_Utils_cmp(n, ((256 * 256) * 256) * 256) < 0) ? ei(
		_List_fromArray(
			[254, n3, n2, n1, n0])) : $elm$bytes$Bytes$Encode$sequence(
		_List_fromArray(
			[
...
var $lamdera$codecs$Lamdera$Wire3$encodeString = function (s) {
	return $elm$bytes$Bytes$Encode$sequence(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeInt64(
				$elm$bytes$Bytes$Encode$getStringWidth(s)),
...
var $elm$core$Set$insert$ = function (key, _v0) {
	var dict = _v0.a;
	return $elm$core$Set$Set_elm_builtin(
		$elm$core$Dict$insert$(key, _Utils_Tuple0, dict));
};
var $elm$core$Set$insert = F2($elm$core$Set$insert$);
...
var $author$project$TestTypes$Point = {$: 'Point'};
var $author$project$TestTypes$Rectangle$ = function (a, b) {
...
var $author$project$TestTypes$Branch = F2($author$project$TestTypes$Branch$);
...
var $lamdera$codecs$Lamdera$Wire3$encodeResult$ = function (encErr, encVal, s) {
	if (s.$ === 'Ok') {
		var v = s.a;
...
var $lamdera$codecs$Lamdera$Wire3$encodeResult = F3($lamdera$codecs$Lamdera$Wire3$encodeResult$);
var $author$project$TestTypes$w3_encode_ApiResponse = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeString(w3_rec_var0.message),
				$lamdera$codecs$Lamdera$Wire3$encodeResult$($lamdera$codecs$Lamdera$Wire3$encodeString, $lamdera$codecs$Lamdera$Wire3$encodeInt, w3_rec_var0.result)
			]));
};
var $author$project$TestTypes$w3_encode_Color = function (w3v) {
	switch (w3v.$) {
		case 'Blue':
...
var $lamdera$codecs$Lamdera$Wire3$encodePair$ = function (c_a, c_b, _v0) {
	var a = _v0.a;
	var b = _v0.b;
	return $elm$bytes$Bytes$Encode$sequence(
		_List_fromArray(
...
var $lamdera$codecs$Lamdera$Wire3$encodePair = F3($lamdera$codecs$Lamdera$Wire3$encodePair$);
var $author$project$TestTypes$w3_encode_Coordinate = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeString(w3_rec_var0.label),
				$lamdera$codecs$Lamdera$Wire3$encodePair$($lamdera$codecs$Lamdera$Wire3$encodeFloat, $lamdera$codecs$Lamdera$Wire3$encodeFloat, w3_rec_var0.point)
			]));
};
var $lamdera$codecs$Lamdera$Wire3$encodeList$ = function (enc, s) {
	return $elm$bytes$Bytes$Encode$sequence(
		A2(
			$elm$core$List$cons,
			$lamdera$codecs$Lamdera$Wire3$encodeInt64(
				$elm$core$List$length(s)),
			$elm$core$List$map$(enc, s)));
};
var $lamdera$codecs$Lamdera$Wire3$encodeList = F2($lamdera$codecs$Lamdera$Wire3$encodeList$);
var $lamdera$codecs$Lamdera$Wire3$encodeDict$ = function (encKey, encValue, d) {
	return $lamdera$codecs$Lamdera$Wire3$encodeList$(
		A2($lamdera$codecs$Lamdera$Wire3$encodePair, encKey, encValue),
		$elm$core$Dict$toList(d));
};
var $lamdera$codecs$Lamdera$Wire3$encodeDict = F3($lamdera$codecs$Lamdera$Wire3$encodeDict$);
var $lamdera$codecs$Lamdera$Wire3$encodeMaybe$ = function (encVal, s) {
	if (s.$ === 'Nothing') {
		return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
			_List_fromArray(
				[
...
var $lamdera$codecs$Lamdera$Wire3$encodeMaybe = F2($lamdera$codecs$Lamdera$Wire3$encodeMaybe$);
var $author$project$TestTypes$w3_encode_Dashboard = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeResult$(
				$lamdera$codecs$Lamdera$Wire3$encodeString,
				$lamdera$codecs$Lamdera$Wire3$encodeMaybe($lamdera$codecs$Lamdera$Wire3$encodeInt),
				w3_rec_var0.nested),
				$lamdera$codecs$Lamdera$Wire3$encodeMaybe$(
				$lamdera$codecs$Lamdera$Wire3$encodeList($lamdera$codecs$Lamdera$Wire3$encodeString),
				w3_rec_var0.optionalData),
				$lamdera$codecs$Lamdera$Wire3$encodeDict$(
				$lamdera$codecs$Lamdera$Wire3$encodeString,
				$lamdera$codecs$Lamdera$Wire3$encodeList($lamdera$codecs$Lamdera$Wire3$encodeInt),
				w3_rec_var0.userScores)
			]));
};
var $lamdera$codecs$Lamdera$Wire3$encodeSet$ = function (encVal, s) {
	return $lamdera$codecs$Lamdera$Wire3$encodeList$(
		encVal,
		$elm$core$Set$toList(s));
};
var $lamdera$codecs$Lamdera$Wire3$encodeSet = F2($lamdera$codecs$Lamdera$Wire3$encodeSet$);
var $author$project$TestTypes$w3_encode_Inventory = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeDict$($lamdera$codecs$Lamdera$Wire3$encodeString, $lamdera$codecs$Lamdera$Wire3$encodeInt, w3_rec_var0.counts),
				$lamdera$codecs$Lamdera$Wire3$encodeList$($lamdera$codecs$Lamdera$Wire3$encodeString, w3_rec_var0.items),
				$lamdera$codecs$Lamdera$Wire3$encodeMaybe$($lamdera$codecs$Lamdera$Wire3$encodeString, w3_rec_var0.selected),
				$lamdera$codecs$Lamdera$Wire3$encodeSet$($lamdera$codecs$Lamdera$Wire3$encodeString, w3_rec_var0.tags)
			]));
};
var $author$project$TestTypes$w3_encode_Person = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$lamdera$codecs$Lamdera$Wire3$encodeBool(w3_rec_var0.active),
				$lamdera$codecs$Lamdera$Wire3$encodeInt(w3_rec_var0.age),
				$lamdera$codecs$Lamdera$Wire3$encodeString(w3_rec_var0.name),
				$lamdera$codecs$Lamdera$Wire3$encodeFloat(w3_rec_var0.score)
			]));
};
var $author$project$TestTypes$w3_encode_Shape = function (w3v) {
	switch (w3v.$) {
		case 'Circle':
			var v0 = w3v.a;
			return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
				_List_fromArray(
					[
						$elm$bytes$Bytes$Encode$unsignedInt8(0),
						$lamdera$codecs$Lamdera$Wire3$encodeFloat(v0)
					]));
		case 'Point':
			return $elm$bytes$Bytes$Encode$unsignedInt8(1);
		default:
			...
			return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
				_List_fromArray(
					[
						...
						$lamdera$codecs$Lamdera$Wire3$encodeFloat(v0),
						$lamdera$codecs$Lamdera$Wire3$encodeFloat(v1)
					]));
	}
};
var $author$project$TestTypes$w3_encode_Team = function (w3_rec_var0) {
	return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
		_List_fromArray(
			[
				$author$project$TestTypes$w3_encode_Color(w3_rec_var0.color),
				$author$project$TestTypes$w3_encode_Person(w3_rec_var0.leader),
				$lamdera$codecs$Lamdera$Wire3$encodeList$($author$project$TestTypes$w3_encode_Person, w3_rec_var0.members)
			]));
};
var $author$project$TestTypes$w3_encode_Tree = function (w3v) {
	if (w3v.$ === 'Branch') {
		var v0 = w3v.a;
		var v1 = w3v.b;
		return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
			_List_fromArray(
				[
					$elm$bytes$Bytes$Encode$unsignedInt8(0),
					$author$project$TestTypes$w3_encode_Tree(v0),
					$author$project$TestTypes$w3_encode_Tree(v1)
				]));
	} else {
		var v0 = w3v.a;
		return $lamdera$codecs$Lamdera$Wire3$encodeSequenceWithoutLength(
			_List_fromArray(
				[
					$elm$bytes$Bytes$Encode$unsignedInt8(1),
					$lamdera$codecs$Lamdera$Wire3$encodeInt(v0)
				]));
	}
};
var $author$project$Harness$handleType$ = function (typeName, bytes) {
	switch (typeName) {
		case 'Person':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Person, $author$project$TestTypes$w3_encode_Person, bytes);
		case 'Color':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Color, $author$project$TestTypes$w3_encode_Color, bytes);
		case 'Shape':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Shape, $author$project$TestTypes$w3_encode_Shape, bytes);
		case 'Inventory':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Inventory, $author$project$TestTypes$w3_encode_Inventory, bytes);
		case 'Team':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Team, $author$project$TestTypes$w3_encode_Team, bytes);
		case 'ApiResponse':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_ApiResponse, $author$project$TestTypes$w3_encode_ApiResponse, bytes);
		case 'Tree':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Tree, $author$project$TestTypes$w3_encode_Tree, bytes);
		case 'Coordinate':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Coordinate, $author$project$TestTypes$w3_encode_Coordinate, bytes);
		case 'Dashboard':
			return $author$project$Harness$roundTrip$($author$project$TestTypes$w3_decode_Dashboard, $author$project$TestTypes$w3_encode_Dashboard, bytes);
		case 'Int':
			return $author$project$Harness$roundTrip$($lamdera$codecs$Lamdera$Wire3$decodeInt, $lamdera$codecs$Lamdera$Wire3$encodeInt, bytes);
		case 'Float':
			return $author$project$Harness$roundTrip$(
				$elm$bytes$Bytes$Decode$float64($elm$bytes$Bytes$LE),
				$elm$bytes$Bytes$Encode$float64($elm$bytes$Bytes$LE),
				bytes);
		case 'Bool':
			return $author$project$Harness$roundTrip$($lamdera$codecs$Lamdera$Wire3$decodeBool, $lamdera$codecs$Lamdera$Wire3$encodeBool, bytes);
		case 'String':
			return $author$project$Harness$roundTrip$($lamdera$codecs$Lamdera$Wire3$decodeString, $lamdera$codecs$Lamdera$Wire3$encodeString, bytes);
		default:
			return 'ERR unknown-type:' + typeName;
	}
};
var $author$project$Harness$handleType = F2($author$project$Harness$handleType$);
var $author$project$Harness$hexValue = function (c) {
	switch (c.valueOf()) {
		case '0':
			return 0;
		case '1':
...
var $author$project$Harness$hexPairs = function (chars) {
	if (chars.b && chars.b.b) {
		var hi = chars.a;
		var _v1 = chars.b;
		var lo = _v1.a;
		var rest = _v1.b;
		return A2(
			$elm$core$List$cons,
			($author$project$Harness$hexValue(hi) * 16) + $author$project$Harness$hexValue(lo),
			$author$project$Harness$hexPairs(rest));
	} else {
		return _List_Nil;
	}
};
...
var $author$project$Harness$hexToBytes = function (hex) {
	return $elm$bytes$Bytes$Encode$encode(
		$elm$bytes$Bytes$Encode$sequence(
			$elm$core$List$map$(
				$elm$bytes$Bytes$Encode$unsignedInt8,
				$author$project$Harness$hexPairs(
...
var $author$project$Harness$responsePort = _Platform_outgoingPort('responsePort', $elm$json$Json$Encode$string);
var $author$project$Harness$update$ = function (msg, _v0) {
	var line = msg.a;
	return _Utils_Tuple2(
		_Utils_Tuple0,
		$author$project$Harness$responsePort(
			$author$project$Harness$processRequest(line)));
};
var $author$project$Harness$update = F2($author$project$Harness$update$);
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Harness$main = $elm$core$Platform$worker(
	{
		init: function (_v0) {
			return _Utils_Tuple2(_Utils_Tuple0, $elm$core$Platform$Cmd$none);
		},
		subscriptions: function (_v1) {
			return $author$project$Harness$requestPort($author$project$Harness$GotRequest);
		},
		update: $author$project$Harness$update
	});
_Platform_export({'Harness':{'init':$author$project$Harness$main(
